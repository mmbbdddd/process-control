...
public class DevPcService extends PcService {
    public <S extends Enum<S>, T extends FlowPayload<S>> void oneStep(String flowName, T payload, String event) throws ActionException, FsmEndException, StatusException {
    ...
    public void oneStep(FlowContext<?, ?> ctx) throws ActionException, FsmEndException, StatusException {
