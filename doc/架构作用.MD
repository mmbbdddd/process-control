...
![img_27.png](img_27.png)
        ...
        技术类apass：如业务网关、南北向网关、配置中心、算法平台……，降低业务交互中通讯协议、加解密、数据格式、算法……等技术复杂度
        业务类apaas：如果合同平台、费率平台、营销平台……，解耦分离业务逻辑本身的复杂度，实现关注点分离，聚焦，做精，领域化通用化配置化。

        应用内部：
        1，核心流程：基于内存状态机，在一致性的前提下，最少的微服务IO。
        2，组件：   可组合，可编排
                业务逻辑组件：action
                非业务逻辑组件：plugin（如日志摘要、监控、埋点……等公用功能。可配置、可复用）
        3，SAO：以RPC方式，整合其他微服务功能。结构清晰。
